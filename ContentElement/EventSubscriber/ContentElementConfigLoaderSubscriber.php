...
namespace Bartacus\Bundle\BartacusBundle\ContentElement\EventSubscriber;
...
final class ContentElementConfigLoaderSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            AdditionalConfigurationEvent::EVENT_NAME => [['loadContentElements', 8]],
        ];
    }
     ...
     */
    public function loadContentElements(AdditionalConfigurationEvent $event): void
    {
