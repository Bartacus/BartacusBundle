...
namespace Bartacus\Bundle\BartacusBundle\ServiceBridge\Compiler;

use Bartacus\Bundle\BartacusBundle\ServiceBridge\MakeInstanceServiceLocator;
        ...
        foreach ($taggedServices as $id => $tags) {
            ...
            foreach ($tags as $attributes) {
                ...
                if (isset($attributes['alias'])) {
                    ...
                    if (!\interface_exists($locatableClass) || !$container->getReflectionClass($locatableClass)) {
